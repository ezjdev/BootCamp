INSERT INTO playlist.artist (id, name, genre, country) VALUES
(1, 'The Beatles', 'Rock', 'United Kingdom'),
...
SELECT setval('playlist.artist_id_seq', 98, true);

INSERT INTO playlist.song (artist_id, title, duration, rating) VALUES
(1, 'Hey Jude', '00:07:11', 5),
